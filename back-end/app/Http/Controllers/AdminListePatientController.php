<?php namespace App\Http\Controllers;
	...
	class AdminListePatientController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:cms_users','width'=>'col-sm-10','placeholder'=>'S\'il vous plaît, mettez une adresse email valide'];
			...
			$this->form[] = ['label'=>'Password','name'=>'password','type'=>'password','validation'=>'min:3|max:32','width'=>'col-sm-10','help'=>'Minimum 5 caractères.S\'il vous plaît laisser vide si vous n\'avez pas changé le mot de passe.'];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:cms_users","placeholder"=>"S'il vous plaît, mettez une adresse email valide"];
			...
			//$this->form[] = ["label"=>"Password","name"=>"password","type"=>"password","required"=>TRUE,"validation"=>"min:3|max:32","help"=>"Minimum 5 caractères.S'il vous plaît laisser vide si vous n'avez pas changé le mot de passe."];
