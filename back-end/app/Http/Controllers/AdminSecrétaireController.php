<?php namespace App\Http\Controllers;
	...
	class AdminSecrétaireController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Nom","name"=>"cms_users_id","join"=>"cms_users,nom"];
			$this->col[] = ["label"=>"Prenom","name"=>"cms_users_id","join"=>"cms_users,prenom"];
			$this->col[] = ["label"=>"Nom medecin","name"=>"medecin_id","join"=>"cms_users,nom"];
			$this->col[] = ["label"=>"Prenom medecin","name"=>"medecin_id","join"=>"cms_users,prenom"];
	    ...
	    */
	    public function hook_query_index(&$query) {
	        //Your code here
			// $query->where('id_cms_privileges', Privilege::PrivilegeID('secretaire'));
